...
class LandingPageController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'price_banner_original_label' => ['nullable', 'string', 'max:255'],
            'price_banner_original_price' => ['nullable', 'string', 'max:50'],
            'price_banner_current_label' => ['nullable', 'string', 'max:255'],
            'price_banner_current_price' => ['nullable', 'string', 'max:50'],
            'mid_order_button_text' => ['nullable', 'string', 'max:100'],
            'mid_order_button_icon' => ['nullable', 'string', 'max:50'],
            'benefits_sections' => ['nullable', 'array'],
            'benefits_sections.*.title' => ['nullable', 'string', 'max:255'],
            'benefits_sections.*.items' => ['nullable', 'array'],
            'benefits_sections.*.items.*' => ['string', 'max:500'],
            ...
            'template' => ['nullable', 'string', 'in:v1'],

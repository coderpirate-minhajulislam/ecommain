...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('landing_pages', function (Blueprint $table) {
            ...
            $table->string('use_cases_subtitle', 500)->nullable();
            $table->json('features')->nullable();
            $table->string('features_title')->nullable();
            $table->string('features_subtitle', 500)->nullable();
            $table->json('specifications')->nullable();
            $table->string('specifications_title')->nullable();
            $table->string('specifications_subtitle', 500)->nullable();
            ...
            $table->string('why_buy_super_text', 255)->nullable();
            $table->string('why_buy_subtitle', 500)->nullable();

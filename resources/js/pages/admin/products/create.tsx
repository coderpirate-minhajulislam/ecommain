...
type VariantRow = { size: string; color: string; price: string; original_price: string; in_stock: boolean; free_shipping: boolean | null; shipping_zones: { zone: string; charge: string }[] };

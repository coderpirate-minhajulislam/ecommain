                    ...
                    <table className="w-full text-sm">
                        <thead className="sticky top-0 border-b bg-muted/50">
                            <tr>
                                ...
                                <th className="hidden whitespace-nowrap px-2 py-3 text-left font-medium sm:px-4 xl:table-cell">Description</th>
                                <th className="whitespace-nowrap px-2 py-3 text-left font-medium sm:px-4">Status</th>
                                <th className="hidden whitespace-nowrap px-2 py-3 text-left font-medium sm:px-4 xl:table-cell">Order</th>
                                <th className="sticky right-0 whitespace-nowrap bg-muted/50 px-2 py-3 text-right font-medium sm:px-4">Actions</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y">
                            {paymentMethods.data.map((method) => (
                                <tr key={method.id} className="group hover:bg-muted/30">
                                    <td className="whitespace-nowrap px-2 py-3 font-medium sm:px-4">{method.name}</td>
                                    <td className="hidden whitespace-nowrap px-2 py-3 text-muted-foreground sm:px-4 lg:table-cell">{method.slug}</td>
                                    <td className="hidden whitespace-nowrap px-2 py-3 text-muted-foreground sm:px-4 xl:table-cell">{method.description || '—'}</td>
                                    ...
                                    <td className="hidden whitespace-nowrap px-2 py-3 text-muted-foreground sm:px-4 xl:table-cell">{method.sort_order}</td>

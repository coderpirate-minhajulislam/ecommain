...
export default function CreatePaymentMethod() {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        post('/admin/payment-methods', { forceFormData: true });
    }
                    ...
                    <div className="space-y-2">
                        ...
                        {logoPreview ? (
                            <div className="relative inline-block">
                                <img src={logoPreview} alt="Logo preview" className="h-16 w-auto rounded-lg border" />
                                <button
                                    type="button"
                                    onClick={() => { setData('logo', null); setLogoPreview(null); }}
                        ...
                        <p className="text-xs text-muted-foreground">Shown on checkout if no logo image is uploaded. Recommended: square image, max 2MB.</p>

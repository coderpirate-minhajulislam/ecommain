...
export default function OrderRatioCheckSettings() {
    const { apiKey, domain, isConnected, minSuccessRatio, blockZeroRatio, codRestrictedMessage } = usePage<Props>().props;
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        post('/admin/settings/orderratiocheck');
    }

    return (
        <>
            <Head title="Order Ratio Check Settings" />
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight">Order Ratio Check</h2>
                    <p className="text-muted-foreground">
                        Connect your store to Order Ratio Check API to verify customer courier success ratios.
                    </p>
                </div>
                    ...
                    <div className="md:col-span-2">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Enter your Order Ratio Check API key from{' '}
                                    <a href="https://app.growever.bd" target="_blank" rel="noopener noreferrer" className="font-medium underline">app.growever.bd</a>. This is used to
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            id="api_key"
                                            type="password"
                                            placeholder="Your Order Ratio Check API key"
                                            value={data.api_key}
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            ...
                                            <a href="https://app.growever.bd" target="_blank" rel="noopener noreferrer" className="font-medium underline">app.growever.bd</a>.
                                        </p>
                                        {errors.api_key && (
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            value={data.domain}
                                            onChange={(e) => setData('domain', e.target.value.trim())}
                                        />
                                        <p className="text-xs text-muted-foreground">
                                            The domain registered with your Growever account (e.g. <span className="font-medium">yourdomain.com</span>). This is sent as the <span className="font-mono">X-Domain</span> header on every server-side request.
                                        </p>
                                        {errors.domain && (
                    ...
                    <div className="space-y-4">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-2 text-sm text-muted-foreground">
                                <p>1. Visit <a href="https://app.growever.bd" target="_blank" rel="noopener noreferrer" className="font-medium underline">app.growever.bd</a></p>
                                <p>2. Sign in to your account</p>
                                <p>3. Navigate to <strong>API Settings</strong></p>
                                <p>4. Copy your <strong>API Key / Bearer Token</strong> and paste it above</p>
                                <p>5. Enter the domain registered with your account</p>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent>
                                <ul className="space-y-2 text-sm text-muted-foreground">
                                    {[
                                        ...
                                        'View data across Steadfast, Pathao, Redx, PaperFly, CarryBee',
                                        'Identify high-risk phone numbers',
...
OrderRatioCheckSettings.layout = {
    breadcrumbs: [
        { title: 'Admin Dashboard', href: '/admin/dashboard' },
        { title: 'Settings', href: '#' },
        { title: 'Order Ratio Check', href: '/admin/settings/orderratiocheck' },
    ],
};
